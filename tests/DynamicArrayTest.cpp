...
TEST_P(DynamicArrayParameterizedTest, RemoveElementAtIndex)
{
    ...
    if (indexToRemove < 0 || indexToRemove >= initialElements.size())
    {
        ASSERT_THROW(arr.Remove(indexToRemove), out_of_range);
    }
    else
    {
...
TEST_P(DynamicArrayParameterizedTest, InsertElementAtIndex)
{
    ...
    if (indexToInsert < 0 || indexToInsert > initialElements.size())
    {
        ASSERT_THROW(arr.Insert(indexToInsert, 100), out_of_range);
    }
    else
    {
